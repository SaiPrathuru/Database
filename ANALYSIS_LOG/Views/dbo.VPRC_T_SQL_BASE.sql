...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[VPRC_T_SQL_BASE]
AS
SELECT                      dbo.VPRC_T_SQL_RENAMED.SystemKey, dbo.VPRC_T_SQL_RENAMED.[Login ID], dbo.VPRC_T_EMPLOYEE_BASE.[Login Type], dbo.VPRC_T_SQL_RENAMED.[Application Name], 
                                      dbo.VPRC_T_SQL_RENAMED.[Query Details], dbo.VPRC_T_SQL_RENAMED.[Database Name], dbo.VPRC_T_SQL_RENAMED.Duration, dbo.VPRC_T_SQL_RENAMED.[Start Date], 
                                      dbo.VPRC_T_SQL_RENAMED.[Start Time], dbo.VPRC_T_SQL_RENAMED.[Start Timestamp], dbo.VPRC_T_EMPLOYEE_BASE.[Result Set], dbo.VPRC_T_EMPLOYEE_BASE.[Match Found], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[Employee ID], dbo.VPRC_T_EMPLOYEE_BASE.[Person ID], dbo.VPRC_T_EMPLOYEE_BASE.[User ID], dbo.VPRC_T_EMPLOYEE_BASE.Username, 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[User Account], dbo.VPRC_T_EMPLOYEE_BASE.[Sequence Number], dbo.VPRC_T_EMPLOYEE_BASE.Hierarchy, dbo.VPRC_T_EMPLOYEE_BASE.[Hierarchy Level], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[DS Number], dbo.VPRC_T_EMPLOYEE_BASE.Email, dbo.VPRC_T_EMPLOYEE_BASE.[Email Address], dbo.VPRC_T_EMPLOYEE_BASE.[User Full Name], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[User First Name], dbo.VPRC_T_EMPLOYEE_BASE.[User Last Name], dbo.VPRC_T_EMPLOYEE_BASE.[Display Name], dbo.VPRC_T_EMPLOYEE_BASE.[Formal Name], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[Birth Name], dbo.VPRC_T_EMPLOYEE_BASE.[Preferred Name], dbo.VPRC_T_EMPLOYEE_BASE.[First Name], dbo.VPRC_T_EMPLOYEE_BASE.[Middle Name], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[Last Name], dbo.VPRC_T_EMPLOYEE_BASE.[Preferred Last Name], dbo.VPRC_T_EMPLOYEE_BASE.[Display Name Kanji], dbo.VPRC_T_EMPLOYEE_BASE.[Formal Name Kanji], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[Birth Name Kanji], dbo.VPRC_T_EMPLOYEE_BASE.[First Name Kanji], dbo.VPRC_T_EMPLOYEE_BASE.[Middle Name Kanji], dbo.VPRC_T_EMPLOYEE_BASE.[Last Name Kanji], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[Preferred Last Name Kanji], dbo.VPRC_T_EMPLOYEE_BASE.[Display Name Kana], dbo.VPRC_T_EMPLOYEE_BASE.[Formal Name Kana], 
...
FROM                         dbo.VPRC_T_SQL_RENAMED LEFT OUTER JOIN
                                      dbo.TPRC_LOGM_EX_SYSTEMS ON dbo.VPRC_T_SQL_RENAMED.SystemKey = dbo.TPRC_LOGM_EX_SYSTEMS.SystemKey LEFT OUTER JOIN
                                      dbo.VPRC_T_EMPLOYEE_BASE ON dbo.VPRC_T_SQL_RENAMED.[Login ID] = dbo.VPRC_T_EMPLOYEE_BASE.[Employee ID]
GO
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "VPRC_T_SQL_RENAMED"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 131
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_SQL_BASE', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_SQL_BASE', NULL, NULL
GO
