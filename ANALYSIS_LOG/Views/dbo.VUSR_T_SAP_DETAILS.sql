...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[VUSR_T_SAP_DETAILS]
AS
SELECT                      [Login ID], [Login Type], [Audit Log Text], [Start Date], [Start Time], [Start Timestamp], [File Name], Bytes, SystemKey, [Email Address], [Transaction Code], [Program ID], Program, [Transaction], [Result Set], 
                                      [Match Found], [Employee ID], [Person ID], [User ID], Username, [User Account], [Sequence Number], Hierarchy, [Hierarchy Level], [DS Number], Email, [Employee Email Address], [User Full Name], 
                                      ...
                                      [Function Head Name], [Function Head Global Unit], [Function Head Global Division], [Status Code], [Assignment Type Code], [Assignment Type], [Employment Assignment Type], isPrimaryMerged, 
                                      ...
                                      [Job Last Modified Date], [Employment Last Modified Date], [Biographic Last Modified Date], [Personal Last Modified Date], [System Group], [System Name], [System Tech Name], Notes
FROM                         dbo.VPRC_T_SAP_BASE
GO
GRANT SELECT ON  [dbo].[VUSR_T_SAP_DETAILS] TO [bi_logs]
GO
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VUSR_T_SAP_DETAILS', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VUSR_T_SAP_DETAILS', NULL, NULL
GO
