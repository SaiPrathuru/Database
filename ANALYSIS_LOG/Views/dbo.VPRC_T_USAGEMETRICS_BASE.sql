...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[VPRC_T_USAGEMETRICS_BASE]
AS
SELECT                      dbo.VPRC_T_USAGEMETRICS_RENAMED.SystemKey, dbo.VPRC_T_USAGEMETRICS_RENAMED.[Distribution Method], dbo.VPRC_T_USAGEMETRICS_RENAMED.Platform, 
                                      dbo.VPRC_T_USAGEMETRICS_RENAMED.[Report GUID], dbo.VPRC_T_USAGEMETRICS_RENAMED.Report, dbo.VPRC_T_USAGEMETRICS_RENAMED.[Report Page], 
                                      dbo.VPRC_T_USAGEMETRICS_RENAMED.[Login ID], dbo.VPRC_T_EMPLOYEE_BASE.[Login Type], dbo.VPRC_T_USAGEMETRICS_RENAMED.[Total Reports in Organization], 
                                      dbo.VPRC_T_USAGEMETRICS_RENAMED.[Viewers Rank], dbo.VPRC_T_USAGEMETRICS_RENAMED.[Views Rank], dbo.VPRC_T_USAGEMETRICS_RENAMED.Views, dbo.VPRC_T_USAGEMETRICS_RENAMED.Viewers, 
                                      dbo.VPRC_T_USAGEMETRICS_RENAMED.[Start Date], dbo.VPRC_T_USAGEMETRICS_RENAMED.[Start Time], dbo.VPRC_T_USAGEMETRICS_RENAMED.[Start Timestamp], dbo.VPRC_T_EMPLOYEE_BASE.[Result Set], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[Match Found], dbo.VPRC_T_EMPLOYEE_BASE.[Employee ID], dbo.VPRC_T_EMPLOYEE_BASE.[Person ID], dbo.VPRC_T_EMPLOYEE_BASE.[User ID], 
                                      ...
                                      dbo.VPRC_T_EMPLOYEE_BASE.[Hierarchy Level], dbo.VPRC_T_EMPLOYEE_BASE.[DS Number], dbo.VPRC_T_EMPLOYEE_BASE.Email, dbo.VPRC_T_EMPLOYEE_BASE.[Email Address], 
...
FROM                         dbo.VPRC_T_USAGEMETRICS_RENAMED LEFT OUTER JOIN
                                      dbo.VPRC_T_EMPLOYEE_BASE ON dbo.VPRC_T_USAGEMETRICS_RENAMED.[Employee ID] = dbo.VPRC_T_EMPLOYEE_BASE.[Employee ID] LEFT OUTER JOIN
                                      dbo.TPRC_LOGM_EX_SYSTEMS ON dbo.VPRC_T_USAGEMETRICS_RENAMED.SystemKey = dbo.TPRC_LOGM_EX_SYSTEMS.SystemKey
GO
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "VPRC_T_USAGEMETRICS_RENAMED"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 136
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_USAGEMETRICS_BASE', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_USAGEMETRICS_BASE', NULL, NULL
GO
