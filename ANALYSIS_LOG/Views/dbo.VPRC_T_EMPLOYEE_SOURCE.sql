...
*/
CREATE VIEW [dbo].[VPRC_T_EMPLOYEE_SOURCE]
AS
...
FROM                         dbo.M_EC_LOG_DW2_EMPLOYEE
GO
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_EMPLOYEE_SOURCE', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_EMPLOYEE_SOURCE', NULL, NULL
GO
