...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[VPRC_T_CUBES_MD_BASE]
AS
SELECT                      dbo.VPRC_T_CUBES_MD_RENAMED.SystemKey, dbo.VPRC_T_CUBES_MD_RENAMED.[Application Name], dbo.VPRC_T_CUBES_MD_RENAMED.[Database Name], dbo.VPRC_T_CUBES_MD_RENAMED.[Login ID], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[Login Type], dbo.VPRC_T_CUBES_MD_RENAMED.[Query Details], dbo.VPRC_T_CUBES_MD_RENAMED.Duration, dbo.VPRC_T_CUBES_MD_RENAMED.[Server Name], 
                                      dbo.VPRC_T_CUBES_MD_RENAMED.[Start Date], dbo.VPRC_T_CUBES_MD_RENAMED.[Start Time], dbo.VPRC_T_CUBES_MD_RENAMED.[Start Timestamp], dbo.VPRC_T_EMPLOYEE_BASE.[Result Set], 
...
FROM                         dbo.VPRC_T_CUBES_MD_RENAMED LEFT OUTER JOIN
                                      dbo.VPRC_T_EMPLOYEE_BASE ON dbo.VPRC_T_CUBES_MD_RENAMED.[Login ID] = dbo.VPRC_T_EMPLOYEE_BASE.[Employee ID] LEFT OUTER JOIN
                                      dbo.TPRC_LOGM_EX_SYSTEMS ON dbo.VPRC_T_CUBES_MD_RENAMED.SystemKey = dbo.TPRC_LOGM_EX_SYSTEMS.SystemKey
GO
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "VPRC_T_CUBES_MD_RENAMED"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 136
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_CUBES_MD_BASE', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_CUBES_MD_BASE', NULL, NULL
GO
