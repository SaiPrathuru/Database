...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[VPRC_T_RAINBOW_BASE]
AS
SELECT                      dbo.VPRC_T_RAINBOW_RENAMED.SystemKey, dbo.VPRC_T_RAINBOW_RENAMED.[Type of Activity], dbo.VPRC_T_RAINBOW_RENAMED.[Login ID], dbo.VPRC_T_EMPLOYEE_BASE.[Login Type], 
                                      dbo.VPRC_T_RAINBOW_RENAMED.[Report Category], dbo.VPRC_T_RAINBOW_RENAMED.Report, dbo.VPRC_T_RAINBOW_RENAMED.[Data Category Name], 
                                      dbo.VPRC_T_RAINBOW_RENAMED.[Exported File Name], dbo.VPRC_T_RAINBOW_RENAMED.[Search Conditions], dbo.VPRC_T_RAINBOW_RENAMED.[Total ROW Count], 
                                      dbo.VPRC_T_RAINBOW_RENAMED.[Start Date], dbo.VPRC_T_RAINBOW_RENAMED.[Start Time], dbo.VPRC_T_RAINBOW_RENAMED.[Start Timestamp], dbo.VPRC_T_EMPLOYEE_BASE.[Result Set], 
...
FROM                         dbo.VPRC_T_RAINBOW_RENAMED LEFT OUTER JOIN
                                      dbo.VPRC_T_EMPLOYEE_BASE ON dbo.VPRC_T_RAINBOW_RENAMED.[Login ID] = dbo.VPRC_T_EMPLOYEE_BASE.[Employee ID] LEFT OUTER JOIN
                                      dbo.TPRC_LOGM_EX_SYSTEMS ON dbo.VPRC_T_RAINBOW_RENAMED.SystemKey = dbo.TPRC_LOGM_EX_SYSTEMS.SystemKey
GO
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[37] 4[28] 2[20] 3) )"
      End
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "VPRC_T_RAINBOW_RENAMED"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 301
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_RAINBOW_BASE', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_RAINBOW_BASE', NULL, NULL
GO
