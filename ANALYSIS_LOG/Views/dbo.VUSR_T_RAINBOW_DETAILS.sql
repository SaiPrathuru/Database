...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[VUSR_T_RAINBOW_DETAILS]
AS
SELECT                      [Type of Activity], [Login ID], [Login Type], [Report Category], Report, [Data Category Name], [Exported File Name], [Search Conditions], [Total ROW Count], [Start Date], [Start Time], [Start Timestamp], 
                                      [Result Set], [Match Found], [Employee ID], [Person ID], [User ID], Username, [User Account], [Sequence Number], Hierarchy, [Hierarchy Level], [DS Number], Email, [Email Address], [User Full Name], 
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "VPRC_T_RAINBOW_BASE"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 136
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VUSR_T_RAINBOW_DETAILS', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VUSR_T_RAINBOW_DETAILS', NULL, NULL
GO
