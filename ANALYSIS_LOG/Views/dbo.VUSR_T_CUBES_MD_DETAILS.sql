...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[VUSR_T_CUBES_MD_DETAILS]
AS
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "VPRC_T_CUBES_MD_BASE"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 136
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VUSR_T_CUBES_MD_DETAILS', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VUSR_T_CUBES_MD_DETAILS', NULL, NULL
GO
