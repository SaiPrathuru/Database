...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[VUSR_T_USAGEMETRICS_DETAILS]
AS
SELECT                      [Login ID], [Login Type], [Distribution Method], Platform, [Report GUID], Report, [Report Page], [Total Reports in Organization], [Viewers Rank], [Views Rank], Views, Viewers, [Start Date], [Start Time], 
                                      [Start Timestamp], [Result Set], [Match Found], [Employee ID], [Person ID], [User ID], Username, [User Account], [Sequence Number], Hierarchy, [Hierarchy Level], [DS Number], Email, [Email Address], 
...
FROM                         dbo.VPRC_T_USAGEMETRICS_BASE
GO
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "VPRC_T_USAGEMETRICS_BASE"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 136
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VUSR_T_USAGEMETRICS_DETAILS', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VUSR_T_USAGEMETRICS_DETAILS', NULL, NULL
GO
