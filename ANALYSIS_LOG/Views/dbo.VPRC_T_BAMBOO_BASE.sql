...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[VPRC_T_BAMBOO_BASE]
AS
SELECT                      dbo.VPRC_T_BAMBOO_RENAMED.[User ID], dbo.VPRC_T_BAMBOO_RENAMED.[Login ID], dbo.VPRC_T_EMPLOYEE_BASE.[Login Type], dbo.VPRC_T_BAMBOO_RENAMED.[Report ID], 
                                      dbo.VPRC_T_BAMBOO_RENAMED.[Report Created By ID], dbo.VPRC_T_BAMBOO_RENAMED.[Report Created Date], dbo.VPRC_T_BAMBOO_RENAMED.[Report Description], 
                                      dbo.VPRC_T_BAMBOO_RENAMED.[Email Address], dbo.VPRC_T_BAMBOO_RENAMED.[Report Category], dbo.VPRC_T_BAMBOO_RENAMED.[Report Format Type], 
                                      dbo.VPRC_T_BAMBOO_RENAMED.[Report Deleted], dbo.VPRC_T_BAMBOO_RENAMED.[Last Modified By ID], dbo.VPRC_T_BAMBOO_RENAMED.[Last Modified Date], 
                                      dbo.VPRC_T_BAMBOO_RENAMED.[Report Name], dbo.VPRC_T_BAMBOO_RENAMED.[Column Count], dbo.VPRC_T_BAMBOO_RENAMED.[Row Count], dbo.VPRC_T_BAMBOO_RENAMED.SystemKey, 
                                      dbo.VPRC_T_BAMBOO_RENAMED.[Start Date], dbo.VPRC_T_BAMBOO_RENAMED.[Start Time], dbo.VPRC_T_BAMBOO_RENAMED.[Start Timestamp], dbo.VPRC_T_EMPLOYEE_BASE.[Result Set], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[Match Found], dbo.VPRC_T_EMPLOYEE_BASE.[Employee ID], dbo.VPRC_T_EMPLOYEE_BASE.[Person ID], dbo.VPRC_T_EMPLOYEE_BASE.[User ID] AS [Employee User ID], 
                                      dbo.VPRC_T_EMPLOYEE_BASE.Username, dbo.VPRC_T_EMPLOYEE_BASE.[User Account], dbo.VPRC_T_EMPLOYEE_BASE.[Sequence Number], dbo.VPRC_T_EMPLOYEE_BASE.Hierarchy, 
                                      dbo.VPRC_T_EMPLOYEE_BASE.[Hierarchy Level], dbo.VPRC_T_EMPLOYEE_BASE.[DS Number], dbo.VPRC_T_EMPLOYEE_BASE.Email, dbo.VPRC_T_EMPLOYEE_BASE.[Email Address] AS [Employee Email Address], 
...
FROM                         dbo.VPRC_T_BAMBOO_RENAMED LEFT OUTER JOIN
                                      dbo.VPRC_T_EMPLOYEE_BASE ON dbo.VPRC_T_BAMBOO_RENAMED.[Employee ID] = dbo.VPRC_T_EMPLOYEE_BASE.[Employee ID] LEFT OUTER JOIN
                                      dbo.TPRC_LOGM_EX_SYSTEMS ON dbo.TPRC_LOGM_EX_SYSTEMS.SystemKey = dbo.VPRC_T_BAMBOO_RENAMED.SystemKey
GO
...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "VPRC_T_BAMBOO_RENAMED"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 136
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_BAMBOO_BASE', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VPRC_T_BAMBOO_BASE', NULL, NULL
GO
