CREATE TABLE [dbo].[M_EC_LOG_DW2_EMPLOYEEINFO_EMPLOYEESOURCE]
(
[Result Set] [nvarchar] (256) COLLATE Japanese_XJIS_100_BIN2 NULL,
[Match Found] [int] NULL,
...
[User ID] [nvarchar] (256) COLLATE Japanese_XJIS_100_BIN2 NULL,
...
GO
ALTER TABLE [dbo].[M_EC_LOG_DW2_EMPLOYEEINFO_EMPLOYEESOURCE] ADD CONSTRAINT [PK_M_EC_LOG_DW2_EMPLOYEEINFO_EMPLOYEESOURCE] PRIMARY KEY CLUSTERED  ([Employee ID]) ON [PRIMARY]
GO
