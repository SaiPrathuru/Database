CREATE TABLE [dbo].[M_EC_LOG_DW2_EMPLOYEEINFO_EMPLOYEESOURCE_Old]
(
...
GO
ALTER TABLE [dbo].[M_EC_LOG_DW2_EMPLOYEEINFO_EMPLOYEESOURCE_Old] ADD CONSTRAINT [PK_M_EC_LOG_DW2_EMPLOYEEINFO_EMPLOYEESOURCE_1] PRIMARY KEY CLUSTERED  ([Employee ID]) ON [PRIMARY]
GO
