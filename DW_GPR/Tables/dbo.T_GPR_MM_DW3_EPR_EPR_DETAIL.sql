CREATE TABLE [dbo].[T_GPR_MM_DW3_EPR_EPR_DETAIL]
(
...
GO
ALTER TABLE [dbo].[T_GPR_MM_DW3_EPR_EPR_DETAIL] ADD CONSTRAINT [PK_T_GPR_MM_DW3_EPR_EPR_DETAIL] PRIMARY KEY CLUSTERED  ([PRD_EPR_DETAIL_ID]) ON [PRIMARY]
GO
