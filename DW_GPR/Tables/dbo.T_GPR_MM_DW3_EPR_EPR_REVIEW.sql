CREATE TABLE [dbo].[T_GPR_MM_DW3_EPR_EPR_REVIEW]
(
...
GO
ALTER TABLE [dbo].[T_GPR_MM_DW3_EPR_EPR_REVIEW] ADD CONSTRAINT [PK_T_GPR_MM_DW3_EPR_EPR_REVIEW] PRIMARY KEY CLUSTERED  ([EPR_EPR_REVIEW_ID]) ON [PRIMARY]
GO
